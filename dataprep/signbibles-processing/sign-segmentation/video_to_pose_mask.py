...
from annotator.dwpose.wholebody import Wholebody, inference_detector, inference_pose
...
def pose_estimate(oriImg):
    ...
    with torch.no_grad():
        ...
        # Draw pose and mask
        pose_img = draw_pose(pose, H, W, hands_scores=[subset[:,92:113], subset[:, 113:]], face_scores=face_scores)
