...
class ProgressGUI:
    def __init__(self, root):
        ...
        self.overall_progress = ttk.Progressbar(progress_frame, orient="horizontal", 
        ...
        self.op_progress = ttk.Progressbar(progress_frame, orient="horizontal", 
                                         length=600, mode="determinate", 
        ...
        self.pause_resume_button = ttk.Button(button_frame, textvariable=self.pause_resume_var, 
...
def example_usage():
    ...
    def process_task():
        ...
        steps = ["Downloading videos", "Segmenting videos", "Extracting pose data", 
                 "Creating segmentation masks", "Preparing dataset"]
