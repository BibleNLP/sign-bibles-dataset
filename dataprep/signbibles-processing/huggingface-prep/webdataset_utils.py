...
if __name__ == "__main__":
    ...
    extract_parser.add_argument("--key", help="Key of sample to extract (if not specified, extracts all samples)")
    ...
    preview_parser.add_argument("--key", help="Key of sample to preview (if not specified, previews first sample)")
    preview_parser.add_argument("--max-frames", type=int, default=300, help="Maximum number of frames to include in preview")
    ...
    if args.command == "list":
        ...
        for i, sample in enumerate(loader):
            ...
            create_preview_video((original, pose, mask, segmentation, metadata_json), preview_path, args.max_frames)
